...
import formation9 from "../medias/formation9.png";
import formation10 from "../medias/formation10.png";
import formation11 from "../medias/formation11.png";
// import formation_g from "../medias/geniestat.png";

//slug function
import createSlug from "../Layout/CreateSlug";

//formateur
import poko from "../medias/geniestat.png";
import bienvenue from "../medias/bienvenue.jpg";
import iba from "../medias/iba.jpg";
import aly from "../medias/aly.jpg";
import yacouba from "../medias/geniestat.png";
...
const FormationsData = [
  ...
  // SIMEAN
  {
    ...
    slug: createSlug("Formation en Analyse de données avec Excel"),
    description: `Ce cours pratique vous permettra de :
  Prendre en main Excel pour l'analyse de donné : Familiarisez-vous avec les fonctionnalités de base d'Excel, un outil incontournable pour la gestion et l'analyse de données.
    Créer vos premières feuilles de calcul analytiquee : Apprenez à organiser, structurer et formater vos données pour en faciliter l'analyse.
...

  {
    ...
    image: formation9,
    title:
      "Apprennez les bases du logicielc R: Cas pratique d'analyses statistiques",
    slug: createSlug(
      "Apprennez les bases du logicielc R: Cas pratique d'analyses statistiques"
    ),
...

  {
    ...
    image: formation7,
    title:
      "Maitriser de A à Z la Collecte des données d'enquête avec Kobotoolbox et XLSForm",
    slug: createSlug(
      "Maitriser de A à Z la Collecte des données d'enquête avec Kobotoolbox et XLSForm"
    ),
    description: `*Ce cours pratique vous permettra de :* \
...

  {
    ...
    image: formation11,
    title:
      "Maîtrisez les Fondamentaux de Excel: Cas pratiques d'automatisation des Factures",
    slug: createSlug(
      "Maîtrisez les Fondamentaux de Excel: Cas pratiques d'automatisation des Factures"
    ),
...

  {
    ...
    slug: createSlug(
      "R pour les Débutants : Initiation en Analyse de Données Simplifiée"
    ),
...

  {
    ...
    image: formation5,
    title:
      "Formation Complète en Collecte des données d'enquête avec Enketo et XLSForm",
    slug: createSlug(
      "Formation Complète en Collecte des données d'enquête avec Enketo et XLSForm"
    ),
  ...
  // Ben
  {
    ...
    slug: createSlug(
      "Formation Excel Masterclass : Le Parcours Complet pour Devenir Expert"
    ),
